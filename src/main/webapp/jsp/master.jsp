...
<div id="container">
    ...
    <div id ="head_right">
        <ul class="nav justify-content-end">
            ...
            <li><a href="master?action=master&sessionLocale=en"><fmt:message key="english" /></a></li>
            <li><a href="master?action=master&sessionLocale=ua"><fmt:message key="ukrainian" /></a></li>
        </ul>
    </div>
